                    ...
                    <div style={{ padding: '16px 18px', display: 'flex', gap: 14, alignItems: 'center' }}>
                        ...
                        <div style={{ flex: 1 }}>
                            <div
                                ...
                                style={{ fontSize: 13, fontWeight: 800, color: '#673DE6', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 2 }}
                            >
                                Assistant Vendo
                            </div>
                            <div
                                className="teaser-text"
                                style={{ fontSize: 14.5, color: '#020617', fontWeight: 600, lineHeight: 1.5 }}
                            >
                                {teaserText}
                            </div>
                        </div>
